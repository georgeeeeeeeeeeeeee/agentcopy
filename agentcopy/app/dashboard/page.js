      ...
      while (true) {
        ...
        for (const line of lines) {
          ...
          try {
            ...
            // Handle credits update from stream
    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Credits display in chat header */}
          {!creditsLoading && credits !== null && (
            <div
              style={{
                ...
                gap: "8px",
                padding: "6px 12px",
                backgroundColor: credits > 0 ? "var(--color-accent-light)" : "#FEF3C7",
                borderRadius: "6px",
                fontSize: "14px",
                color: credits > 0 ? "var(--color-accent)" : "#92400E",
                fontWeight: "500",
              }}
            >
        ...
        {/* Input area - show BuyMoreCredits if no credits */}
        {credits === 0 ? (
          <div
            style={{
              background: "var(--color-card)",
